...
if __name__ == "__main__":
    ...
    configs = {
        ...
        "training_set": [
            os.path.join('/home/lucas/Documents/data/TIP2020/',f) for f in os.listdir('/home/lucas/Documents/data/TIP2020/')
        ],
        "validation_set": [
            os.path.join('/home/lucas/Documents/data/TIP2021/',f) for f in os.listdir('/home/lucas/Documents/data/TIP2021/')
        ],
        "epochs": 1, # 300,
