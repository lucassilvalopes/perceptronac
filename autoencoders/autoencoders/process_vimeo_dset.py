...
if __name__ == "__main__":
    ...
    src = "/home/lucaslopes/vimeo_septuplet"
    ...
    for pth in lst:
        ...
        # new_fl = fl.replace("vimeo_triplet","vimeo_singlet")
        new_fl = fl.replace("vimeo_septuplet","vimeo_singlet_p2")

        # break_pt = new_fl.index("vimeo_singlet/")+len("vimeo_singlet/")
        break_pt = new_fl.index("vimeo_singlet_p2/")+len("vimeo_singlet_p2/")
